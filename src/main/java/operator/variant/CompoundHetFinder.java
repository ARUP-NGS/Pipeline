...
//	}
	...
	private void writeHit(PrintStream out, CompoundHetHit hit) {
		...
		if (parent1Pool != null) {
			...
			if (par1Var1 != null) {
				if (par1Var1.getZygosity() == GTType.HET) {
					par1Var1Zyg = "het";
				} else if (par1Var1.getZygosity() == GTType.HOM) {
					par1Var1Zyg = "hom";
				} else if (par1Var1.getZygosity() == GTType.HEMI) {
					par1Var1Zyg = "hemi";
				} else if (par1Var1.getZygosity() == GTType.UNKNOWN) {
					par1Var1Zyg = "unknown";
				}
			}
			
			if (par1Var2 != null) {
				if (par1Var2.getZygosity() == GTType.HET) {
					par1Var2Zyg = "het";
				} else if (par1Var2.getZygosity() == GTType.HOM) {
					par1Var2Zyg = "hom";
				} else if (par1Var2.getZygosity() == GTType.HEMI) {
					par1Var2Zyg = "hemi";
				} else if (par1Var2.getZygosity() == GTType.UNKNOWN) {
					par1Var2Zyg = "unknown";
				}
			}
		}
		...
		if (parent2Pool != null) {
			...
			//If par1Var1 exists (variant 1 is in parent 1), then create a string with the zygosity in parent 1
			if (par2Var1 != null) {
				if (par2Var1.getZygosity() == GTType.HET) {
					par2Var1Zyg = "het";
				} else if (par2Var1.getZygosity() == GTType.HOM) {
					par2Var1Zyg = "hom";
				} else if (par2Var1.getZygosity() == GTType.HEMI) {
					par2Var1Zyg = "hemi";
				} else if (par2Var1.getZygosity() == GTType.UNKNOWN) {
					par2Var1Zyg = "unknown";
				}
			}
			
			if (par2Var2 != null) {
				if (par2Var2.getZygosity() == GTType.HET) {
					par2Var2Zyg = "het";
				} else if (par2Var2.getZygosity() == GTType.HOM) {
					par2Var2Zyg = "hom";
				} else if (par2Var2.getZygosity() == GTType.HEMI) {
					par2Var2Zyg = "hemi";
				} else if (par2Var2.getZygosity() == GTType.UNKNOWN) {
					par2Var2Zyg = "unknown";
				}
			}
		}
	...
	public static boolean isHetero(int pos, List<VariantRec> list) {
		for(VariantRec rec : list) {
			if (rec.getStart()==pos && rec.getZygosity() == GTType.HET) {
				return true;
			}
		}
		return false;
