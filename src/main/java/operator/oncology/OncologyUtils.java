...
public class OncologyUtils extends IOOperator {
	...
	public void performOperation() throws OperationFailedException, JSONException, IOException {
		...
		*/
		...
		summary.put("fraction of reads mapped to ratio reference passing map filter.",passMappedRatio/InFq);
		summary.put("fraction of reads mapped to fusion reference passing map filter.",passMappedFusion/InFq);
		summary.put("fraction of reads mapped to ratio reference passing both map and mismatch filters.",passMatchRatio/InFq);
		summary.put("fraction of reads mapped to fusion reference passing both map and mismatch filters.",passMatchFusion/InFq);
		summary.put("fraction of reads mapped to ratio reference failing map filter.", mapFilterRatioCount/InFq);
		summary.put("fraction of reads mapped to fusion reference failing map filter.", mapFilterFusionCount/InFq);
		summary.put("fraction of reads mapped to ratio reference failing match filter.", mismatchFilterRatioCount/InFq);
		summary.put("fraction of reads mapped to fusion reference failing match filter.", mismatchFilterFusionCount/InFq);		
