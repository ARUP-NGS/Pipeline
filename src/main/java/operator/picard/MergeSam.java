...
public class MergeSam extends IOOperator {
	...
	public void performOperation() throws OperationFailedException {
		...
		String fileList = "";
	    Logger.getLogger(Pipeline.primaryLoggerName).info("PicardTools is merging the input files.");
		...
		String command = "java -Xms2G -Xmx20G" + jvmargs + " -jar " + picardDir + "/MergeSamFiles.jar " + fileList + " O=" + outBam.getAbsolutePath()+" USE_THREADING=true CREATE_INDEX=true MSD=true" ;
